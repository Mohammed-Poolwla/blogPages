  ...
  try {
    ...
    const options = {
      ...
      body: JSON.stringify({
        ...
        prompt: `Create a visually engaging image inspired by the topic "${topic}" and the title "${prompt}". Use illustrative elements, symbols, or abstract visuals that represent the theme effectively, without including any text.`,
      }),
    };
      ...
      messages: [
        {
          role: "system",
          content:
            "Generate an SEO-optimized title with the most searchable keywords for the given blog content and title should under 200 character",
        },
